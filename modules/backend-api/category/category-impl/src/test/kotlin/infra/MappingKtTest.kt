...
//    }
    ...
    @Test
    fun testMapper() {
        val converterPerson = Mappers.getMapper(PersonConverter::class.java) // or PersonConverterImpl()
        val converter = Mappers.getMapper(MyCategoryDtoConverter::class.java) // or PersonConverterImpl()

        val category = MyCategory("id", "name", "parentId", "path").toDto(MyCategoryDtoConverter::class.java)
        println(category)
